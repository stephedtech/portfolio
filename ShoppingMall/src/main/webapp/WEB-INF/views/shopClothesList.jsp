						...
						<c:forEach var="clothes" items="${clothesList}">
							<div class="col-sm-4 col-md-3 box-product-outer">
								<div class="box-product">
									...
									<h4>
										<a href="./productInfo?pnum=${clothes.pnum}">${clothes.pname}</a>
									</h4>
									<div class="price">
										<div>${clothes.pprice}원<span class="price-down">${clothes.ppoint}포인트</span>
										</div>
									...
									<div class="rating">
										<i class="ace-icon fa fa-star"></i> <i
											...
											class="ace-icon fa fa-star"></i> <i
											class="ace-icon fa fa-star"></i> <i
											class="ace-icon fa fa-star-half-o"></i> <a href="#">${clothes.reviewCnt}</a>
									</div>
								</div>
							</div>
						</c:forEach>
