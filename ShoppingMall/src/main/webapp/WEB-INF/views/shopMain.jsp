						...
						<c:forEach var="newproduct" items="${newList}">
							<div class="col-sm-4 col-md-3 box-product-outer">
								<div class="box-product">
									...
									<div class="price">
										<div>${newproduct.pprice}원<span class="price-down">평점${newproduct.pavg}</span>
										</div>
							...
							<c:forEach var="bestproduct" items="${bestList}">
								<div class="col-sm-4 col-md-3 box-product-outer">
									<div class="box-product">
										...
										<div class="price">
											<div>${bestproduct.pprice}원<span class="price-down">평점${bestproduct.pavg}</span>
											</div>
											<span class="price-old">$15.00</span>
										</div>
										<div class="rating">
